...
$query4 = "INSERT INTO message (`senderid`, `reciverid`, `message` ) VALUES ('$loginuserid', '$userfriendid', '$usermessage');";
...
for($i=0;$i<$orowcount;)
{
	...
	echo "<table class='s-12 m-8 l-9'><tr><td><span class='fas fa-circle' style='font-size:18px;color:green;'></span><a href='chat.php?userfriendid=".$ouserid[$i]."' style='font-size:150%;color:black;'>".$ouserid[$i]."</a></td></tr></table>";
	}
	$i++;
}
...
for($i=0;$i<$frowcount;)
{
	...
	echo "<table><tr class='s-12 m-8 l-9'><td style='font-size:200%;color:black;width:10%;'><a href='chat.php?userfriendid=".$fuserid[$i]."'>".$fuserid[$i]."</a></td></tr></table>";
	}
	$i++;
}
?>
